...
export const EXPENSE_CATEGORIES: ExpenseCategory[] = [
  ...
  },
  {
    ...
    emoji: "💵",
    subcategories: [
      { id: "salary", nameEn: "Salary", nameBm: "Salary" },
      { id: "freelance", nameEn: "Freelance", nameBm: "Freelance" },
      { id: "business_income", nameEn: "Business", nameBm: "Business" },
      { id: "commission", nameEn: "Commission", nameBm: "Commission" },
      { id: "bonus", nameEn: "Bonus", nameBm: "Bonus" },
      { id: "overtime", nameEn: "Overtime", nameBm: "Overtime" },
      { id: "rental_income", nameEn: "Rental", nameBm: "Rental" },
      { id: "dividend", nameEn: "Dividend", nameBm: "Dividend" },
      { id: "interest_income", nameEn: "Interest", nameBm: "Interest" },
      { id: "other_income", nameEn: "Other Income", nameBm: "Other income" },
    ],
  },
  {
    id: "other",
