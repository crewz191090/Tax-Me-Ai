...
export const translations = {
  en: {
    ...
    "expenses.budgetTitle": "Monthly budgets",
    "expenses.budgetSubtitle": "Set a monthly limit per category and track how much you've spent this month.",
    "expenses.budgetAdd": "Add budget",
    "expenses.budgetCategory": "Category",
    "expenses.budgetLimit": "Monthly limit (RM)",
    "expenses.budgetSave": "Save",
    "expenses.budgetNone": "No budgets set yet.",
    "expenses.budgetOver": "Over budget",
  ...
  bm: {
    ...
    "expenses.budgetTitle": "Budget bulanan",
    "expenses.budgetSubtitle": "Tetapkan had bulanan bagi setiap kategori dan jejak berapa banyak dibelanja bulan ini.",
    "expenses.budgetAdd": "Tambah budget",
    "expenses.budgetCategory": "Kategori",
    "expenses.budgetLimit": "Had bulanan (RM)",
    "expenses.budgetSave": "Simpan",
    "expenses.budgetNone": "Belum ada budget ditetapkan.",
    "expenses.budgetOver": "Melebihi budget",
