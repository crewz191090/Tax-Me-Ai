...
export const translations = {
  en: {
    ...
    "tax.yearlySummary": "Yearly tax summary",
    "tax.yearlySummarySubtitle": "Every deductible receipt for the year, ready to download for LHDN.",
    "tax.exportPdf": "Export PDF",
    "tax.exportCsv": "Export CSV",
    "tax.exporting": "Preparing…",
    "tax.colDate": "Date",
    "tax.colMerchant": "Merchant",
    "tax.colCategory": "Relief category",
    "tax.colAmount": "Amount (RM)",
    "tax.colClaimable": "Claimable (RM)",
    ...
    "dashboard.syncFailedNotice": "These items were rejected by the server (not a connectivity issue) and will keep failing on every retry until fixed or discarded:",
    "dashboard.discardFailed": "Discard failed item(s)",
    ...
    "expenses.viewTransactions": "View transactions",
    "expenses.transactionsFor": "Transactions — {category}",
    "expenses.noTransactions": "No transactions in this category yet.",
    ...
    "upload.drop": "Drop a receipt photo here",
    ...
    "upload.sourceManual": "✍️ Manual",
    "upload.manualAdd": "Add manual expense",
    "upload.manualHint": "No receipt? Attach a related photo (e.g. bank transfer screenshot), or continue without one.",
    "upload.noImage": "Continue without image",
    "upload.notReceiptError": "This doesn't look like a receipt or bank transaction. Please upload a valid receipt or bank transfer screenshot.",
    ...
    "upload.loanTenure": "Loan / installment tenure",
    "upload.loanTenureNone": "Not a loan",
    "upload.months": "months",
    "upload.splitEnable": "Open calculator",
    "upload.calculatorTitle": "Calculator",
    "upload.errorMerchant": "Please fill in the merchant/title before saving.",
    "upload.errorDate": "Please fill in the date before saving.",
    "upload.errorAmount": "Please fill in a valid amount before saving.",
    ...
    "expenses.budgetSubtitle": "Add every income source for the month — every transaction is auto-deducted from the total.",
    "expenses.budgetAdd": "Add income",
    "expenses.budgetAddAnother": "Add another income",
    "expenses.budgetEdit": "Edit",
    "expenses.budgetIncomeAmount": "Amount (RM)",
    "expenses.budgetIncomeType": "Type of income",
    "expenses.budgetLabel": "Label (optional)",
    "expenses.budgetLabelPlaceholder": "e.g. Salary, Side hustle",
    "expenses.budgetSave": "Save",
    "expenses.budgetRemove": "Remove",
    "expenses.budgetCancel": "Cancel",
    "expenses.budgetNone": "No income set for this month yet.",
    "expenses.budgetTotalIncome": "Total income",
    "expenses.budgetOver": "Over income",
    "expenses.budgetRemaining": "Remaining",

    "cashflow.title": "Income vs Expense",
    "cashflow.subtitle": "For",
    ...
    "clone.title": "Clone last month's expenses",
    "clone.subtitle": "Recurring bills and loan installments from last month you haven't added yet this month.",
    "clone.show": "Show {n} suggestion(s)",
    "clone.hide": "Hide",
    "clone.cloneSelected": "Clone selected ({n})",
    "clone.cloning": "Cloning…",
    "clone.installment": "Installment",
  ...
  bm: {
    ...
    "tax.yearlySummary": "Ringkasan cukai tahunan",
    "tax.yearlySummarySubtitle": "Semua resit boleh dilepas cukai bagi tahun ini, sedia dimuat turun untuk LHDN.",
    "tax.exportPdf": "Eksport PDF",
    "tax.exportCsv": "Eksport CSV",
    "tax.exporting": "Sedang disediakan…",
    "tax.colDate": "Tarikh",
    "tax.colMerchant": "Peniaga",
    "tax.colCategory": "Kategori pelepasan",
    "tax.colAmount": "Jumlah (RM)",
    "tax.colClaimable": "Boleh dituntut (RM)",
    ...
    "dashboard.syncFailedNotice": "Item ini ditolak oleh server (bukan masalah sambungan) dan akan terus gagal setiap kali cuba sehingga dibetulkan atau dibuang:",
    "dashboard.discardFailed": "Buang item yang gagal",
    ...
    "expenses.viewTransactions": "Lihat transaksi",
    "expenses.transactionsFor": "Transaksi — {category}",
    "expenses.noTransactions": "Belum ada transaksi dalam kategori ini.",
    "expenses.trend": "Trend",
    ...
    "expenses.exportPdf": "Eksport PDF",

    "image.view": "Lihat",
    "image.download": "Muat turun",
    "image.close": "Tutup",

    "upload.drop": "Letak gambar resit di sini",
    "upload.hint": "JPG, PNG atau WEBP — sehingga 10MB",
    "upload.chooseGallery": "Pilih dari galeri",
    "upload.takePhoto": "Ambil gambar",
    ...
    "upload.sourceManual": "✍️ Manual",
    "upload.manualAdd": "Tambah perbelanjaan manual",
    "upload.manualHint": "Tiada resit? Lampirkan gambar berkaitan (cth: tangkapan skrin pemindahan bank), atau teruskan tanpa gambar.",
    "upload.noImage": "Teruskan tanpa gambar",
    "upload.notReceiptError": "Ini tidak kelihatan seperti resit atau transaksi bank. Sila muat naik resit atau tangkapan skrin pemindahan bank yang sah.",
    ...
    "upload.loanTenure": "Tempoh pinjaman / ansuran",
    "upload.loanTenureNone": "Bukan pinjaman",
    "upload.months": "bulan",
    "upload.splitEnable": "Buka kalkulator",
    "upload.calculatorTitle": "Kalkulator",
    "upload.errorMerchant": "Sila isi peniaga/tajuk sebelum simpan.",
    "upload.errorDate": "Sila isi tarikh sebelum simpan.",
    "upload.errorAmount": "Sila isi jumlah yang sah sebelum simpan.",
    ...
    "expenses.budgetSubtitle": "Tambah setiap sumber pendapatan bulan ini — setiap transaksi akan ditolak automatik daripada jumlahnya.",
    "expenses.budgetAdd": "Tambah pendapatan",
    "expenses.budgetAddAnother": "Tambah pendapatan lain",
    "expenses.budgetEdit": "Edit",
    "expenses.budgetIncomeAmount": "Jumlah (RM)",
    "expenses.budgetIncomeType": "Jenis pendapatan",
    "expenses.budgetLabel": "Label (pilihan)",
    "expenses.budgetLabelPlaceholder": "cth: Gaji, Kerja sampingan",
    "expenses.budgetSave": "Simpan",
    "expenses.budgetRemove": "Buang",
    "expenses.budgetCancel": "Batal",
    "expenses.budgetNone": "Belum ada pendapatan ditetapkan untuk bulan ini.",
    "expenses.budgetTotalIncome": "Jumlah pendapatan",
    "expenses.budgetOver": "Melebihi pendapatan",
    "expenses.budgetRemaining": "Baki",

    "cashflow.title": "Pendapatan vs Perbelanjaan",
    "cashflow.subtitle": "Bagi",
    ...
    "clone.title": "Klon perbelanjaan bulan lepas",
    "clone.subtitle": "Bil berulang dan ansuran pinjaman dari bulan lepas yang belum ditambah bulan ini.",
    "clone.show": "Tunjuk {n} cadangan",
    "clone.hide": "Sembunyi",
    "clone.cloneSelected": "Klon dipilih ({n})",
    "clone.cloning": "Mengklon…",
    "clone.installment": "Ansuran",
